...
Shader::Shader(const char* vertexPath, const char* fragmentPath) {
    ...
    std::cout << "Is vertax path null? " << (vertexPath == nullptr) << " Is fragment path null? " << (fragmentPath == nullptr) << std::endl;
    std::cout << "Vertex path is " << vertexPath << std::endl;
    // std::cout << "Cur dir: " << std::filesystem::current_path().string() << std::endl << std::flush;
    std::cout << std::endl;
    ...
    try {
        ...
        std::cout << "failure " << e.what() << std::endl  << std::flush;
    } catch (...) {
        std::cout << "A really bad error occurred." << std::endl << std::flush;
    }
